...
th = [89.37424043658498, 508.4745762711865]
df_dic_ = {}
df_dic_['an_ESC_FAX'] = peaks(conc_data.copy(),['an_ESC_FAX',th])
df_dic_['an_ESC_FAX_PD03'] = peaks(conc_data.copy(),['an_ESC_FAX_PD03',th])
...
cells_conc = {'an_ESC_FAX_PD03':[15,39],'an_ESC_FAX':[33,50]}

conc_labels = {'an_ESC_FAX_PD03':'MEKi','an_ESC_FAX': 'serum + LIF'}
...
data_folder = '/home/fabris/Documents/Trabajo/Doctorado/Dyncode/DO2020/EpiSC_ESC_Experiment/ESC/data/'
save_folder = '/home/fabris/Documents/Trabajo/Doctorado/Dyncode/DO2020/EpiSC_ESC_Experiment/ESC/figures/'
dataset_name='ESC'

filename = data_folder + dataset_name + '.pkl'
infile = open(filename,'rb')
conc_df = pickle5.load(infile)
infile.close()


filename = data_folder + 'df_results_WT_Norm_.pkl'  
infile =  open(filename,'rb')
df_result_WT = pickle5.load(infile)
infile.close()

filename = data_folder + 'df_results_CN_Norm_.pkl'
infile =  open(filename,'rb')
df_result_CN = pickle5.load(infile)
infile.close()
...
for w, heatmap_values_ in enumerate([df_result_CN,df_result_WT]):
    ...
    ax.plot([89], [508],marker="v", markersize=4, alpha=1, color="red",linewidth = 0)
...
for k,l in enumerate(['level_1']):
    ...
    ax2.plot(12, 0.017, marker="v", markersize=4, alpha=1, color="red",linewidth = 0)
...
plt.savefig(save_folder+'level_curve.pdf', format='pdf')
