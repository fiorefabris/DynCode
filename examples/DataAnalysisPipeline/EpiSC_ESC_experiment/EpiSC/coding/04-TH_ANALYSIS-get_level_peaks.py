...
def main(dat,nprocs,df_dic,filename_dat,key,target_conc): 
    ...
    filename_WT = 'df_results_curve_'+target_conc+'_'+filename_dat[-11:]
    filename_CN = 'df_results_curve_CN_'+filename_dat[-11:]
...
for level in ['level_1.pkl','level_2.pkl','level_3.pkl']:
    filename_dat = 'expl_CN_'+level
